...
#define aoc_da_resize(da_array_p, new)                                    \
    ...
    {                                                                     \
        ...
        {                                                                 \
            ...
            (da_array_p)->items =                                         \
                realloc((da_array_p)->items,                              \
                        sizeof(new) * (da_array_p)->capacity);            \
...
#define aoc_da_insert(da_array_p, new, index)                         \
    ...
    {                                                                 \
        ...
        aoc_da_resize((da_array_p), new);                             \
        memmove(&(da_array_p)->items[index + 1],                      \
                &(da_array_p)->items[index],                          \
...
#define aoc_da_del(da_array_p, index)                                 \
    ...
    {                                                                 \
        ...
        assert(index > -1 && "Index too Small!");                     \
        (da_array_p)->count--;                                        \
        memmove(&(da_array_p)->items[index],                          \
                &(da_array_p)->items[index + 1],                      \
